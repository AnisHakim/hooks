...
function App() {
  const [movies, setMovies] = useState([{
    ...
    image: "https://i.pinimg.com/originals/b4/eb/a7/b4eba7a147337bf972acd26be4dd8299.jpg",
    posterUrl: "https://www.imdb.com/title/tt0232500/",
    rating: "8/10"
  }, {
    title: "Tom & Jerry",
    description: "Animated movie",
    image: "https://fr.web.img2.acsta.net/pictures/20/12/28/10/09/5991258.jpg",
  ...
  const searchClick = (e) => {
    ...
    if (filter !== '') {
      const arr = movies.filter(movie => (movie.title === filter) || (movie.rating === filter))
  ...
  return (
    <div className="App">
      ...
      {filteredMovies == '' ?
        ...
        <div> <MovieList movies={filteredMovies} />
          <button onClick={handleClick}> Add Movie</button>
        </div>
      }
